...
import 'package:ui_ux/src/ui/global_widgets/is_auth.dart';
...
abstract class Pages {
  ...
  static final Map<String, Widget Function(BuildContext)> routes = {
    ...
    Routes.HOME: (_) => IsAuth(page: HomePage()),
    Routes.DISH: (_) => IsAuth(page: DishPage()),
    Routes.MY_CART: (_) => IsAuth(page: MyCartPage()),
